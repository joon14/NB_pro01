	...
	<section class="page" id="page1">
		<div style="width:1400px; margin:0 auto;">
			...
			<ul class="nav nav-tabs">
			  <li class="nav-item">
			    <a class="nav-link active" href="${path0 }/member/terms.jsp">회원약관</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link" href="${path0 }/member/policy.jsp">개인정보처리방침</a>
			  </li>
			</ul>
			</div>
		</div>
		...
		<div style="width:1400px; margin:0 auto;">
			<h3 class="page_title"><i class="fas fa-paste"></i>&nbsp;&nbsp;회원약관</h3>
			<hr>
