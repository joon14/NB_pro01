		...
		<div style="width:1400px; margin:0 auto;">
			...
			<form action="${path0 }/EditProNotice.do" method="post">
				<table class="table table-striped">
					<tbody>
						...
						<tr>
							...
							<td>
								<textarea name="content" id="content" rows="8" cols="80" class="form-control" value="${notice.content }"></textarea>
							</td>
						</tr>
						<tr>
				...
				<div class="btn-group">
					...
					<a href="${path0 }/GetNotice.do?no=${notice.no }" class="btn btn-secondary">글 상세보기</a>
				</div>
			</form>
		</div>
	</section>
